...
<title>Weight due to Methods</title>
<link rel="stylesheet"
		...
		<div class="card">
			<table class="table table-hover shopping-cart-wrap">
				...
				<tbody>
					<tr>
						<td>
							<h4>Method with a primitive return type:</h4>
						</td>
					...
					<tr>
						<td>
							<h4>Method with a composite return type:</h4>
						</td>
						<td><select class="form-control">
								<option>1</option>
								<option>2</option>
					...
					<tr>
						<td>
							<h4>Method with a void return type:</h4>
						</td>
						<td><select class="form-control">
								<option>1</option>
								<option>2</option>
					...
					<tr>
						<td>
							<h4>Primitive data type parameter:</h4>
						</td>
						<td><select class="form-control">
								<option>1</option>
								<option>2</option>
					...
					<tr>
						<td>
							<h4>Composite data type parameter:</h4>
						</td>
						<td><select class="form-control">
								<option>1</option>
								<option>2</option>
