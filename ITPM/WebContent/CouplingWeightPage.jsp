		...
		<div class="card">
			<table class="table table-hover shopping-cart-wrap">
				...
				<tbody>
					...
					<tr>
						<td>
							<h4>A regular method calling another regular method in the same file:</h4>
						</td>
						<td><select class="form-control">
								<option>1</option>
								<option>2</option>
					...
					<tr>
						<td>
							<h4>A regular method calling another regular method in a different file:</h4>
						</td>
						<td><select class="form-control">
								<option>1</option>
								<option>2</option>
					...
					<tr>
						<td>
							<h4>A recursive method calling another recursive method in the same file:</h4>
						</td>
						<td><select class="form-control">
								<option>1</option>
								<option>2</option>
					...
					<tr>
						<td>
							<h4>A recursive method calling another recursive method in a different file:</h4>
						</td>
						<td><select class="form-control">
								<option>1</option>
								<option>2</option>
